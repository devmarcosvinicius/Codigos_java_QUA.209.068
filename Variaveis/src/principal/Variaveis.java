...
public class Variaveis {
	...
	public static void main(String[] args) {
		...
		// O char é criado com aspas simples.
		char sexo = 'M';

		// booleans são valores verdadeiros ou falso.
		boolean verdadeiro = true;
		boolean falso = false;

		// Impressão das variaveis na tela.
		...
		// println quebra linha ao final da impressão.
		System.out.print("Meu nome: ");
		// print não quebra linha ao final da impressão.
		...
		System.out.print("Meu nome é: " + nome + ", sou do sexo: " + sexo + ". Tenho " + idade + " anos de idade e peso " + peso + " kg.");
